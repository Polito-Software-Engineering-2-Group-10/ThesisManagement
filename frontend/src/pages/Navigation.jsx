    ...
    return (
        <Navbar expand="lg" bg='primary' data-bs-theme="dark">
            <Container>
                ...
                {props.loggedIn && (
                    <Nav className="justify-content-center" style={{ marginLeft: '20px' }}>
                        ...
                        <Nav.Item>
                            <Nav.Link>
                                <i className="bi bi-pencil mx-2" onClick={handleEditClick}></i>
                            </Nav.Link>
                        </Nav.Item>
                    </Nav>
                )}
                ...
                {props.loggedIn ? (
                    <Nav className="justify-content-end">
                        <Nav.Item className='mt-1' style={{ marginRight: '20px' }}>
                            <span style={{ fontSize: '18px', color: 'rgba(255, 255, 255, 0.7)' }}>
                                Logged in as: <u>{props.user.name} {props.user.surname}</u>
                            </span>
                        </Nav.Item>
                        <Nav.Item>
                ...
                <Modal show={showModal} onHide={handleCloseModal}>
                    ...
                    <Modal.Footer className="d-flex justify-content-between">
                        <Button variant="secondary" onClick={() => handleVirtualClockClick(false)}>
                            Reset to current date
                        </Button>
                        <Button variant="primary" onClick={() => handleVirtualClockClick(true)}>
                            Set date
                        </Button>
                    </Modal.Footer>
                </Modal>
